...
"""
    ...
    def __init__(self, mesh: Mesh, *args, **kwargs) -> None:
        """Initialize the TriangleManim2DMesh instance."""
    ...
    def edge_flip(self, scene: m.Scene, face_idx_1: int, face_idx_2: int, **kwargs) -> None:
        ...
        triangles becomes the new shared edge.  Raises an error if the
        faces are not both triangles or do not share exactly one edge.
        ...
        face_idx_1 : int
            Index of the first triangle face.
        face_idx_2 : int
