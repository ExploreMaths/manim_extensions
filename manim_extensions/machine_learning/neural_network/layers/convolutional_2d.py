...
# SPDX-License-Identifier: MIT
"""Convolutional 2D layer for neural network visualizations.

This module provides the convolutional 2D layer class for neural network visualizations.
...
class FeatureMap(VGroup):
    ...
    def __init__(
        ...
        """Initialize a feature map as a gridded rectangle with optional dashed padding border."""
        super().__init__()
        self.color = color
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the 2D convolutional layer with feature map count, size, and styling."""
