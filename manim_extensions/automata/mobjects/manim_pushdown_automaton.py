    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        super().__init__(
            json_template, xml_file, camera_follow, animation_style, **kwargs
        )
    ...
    def construct_transition(
        ...
        rules: list[PushDownAutomatonRule],
    ) -> None:
        ...
        """
        new_transition = ManimPushDownAutomatonTransition(
            transition_from,
            transition_to,
            rules,
    ...
    def automaton_step(
    ...
    ) -> tuple[bool, list[State], list[ManimTransition]]:
        ...
        for transition in state_transitions:
            ...
            for (
                rule
            ) in transition.rules:  # Iterate through the transtion's read options
                if (
                    rule.read_symbol == token.tex_string
                    or rule.read_symbol == r"\epsilon"
                ):
...
class PushDownAutomatonRule:
    ...
    def __init__(
        self, read_symbol: str, pop: str, push: str, empty_transition: str = r"\epsilon"
    ) -> None:
