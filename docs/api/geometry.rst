...
Manim primitives (:class:`~manim.mobject.geometry.Circle`, :class:`~manim.mobject.geometry.Line`,
:class:`~manim.mobject.geometry.Arc`) without creating any on-screen mobjects.  They are useful
